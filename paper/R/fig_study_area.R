# fig_study_area.R --- 3-panel study area figure (v2 substantive rework)
# Migration of scripts/fig_study_area_v2.py.
...
# (c) Class distribution bar chart
# Run: Rscript paper/R/fig_study_area.R  (cwd = project root)
...
OUT_PDF <- "figures/study_area.pdf"
...
panel_c <- ggplot(class_counts, aes(count, class, fill = class)) +
...
save_paper(fig, OUT_PDF, width_cm = 18.0, height_cm = 9.0)
